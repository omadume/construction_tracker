# If I opt to use a tool like Whenever gem or Sidekiq, I can manage the daily_snapshot_job via this rake task instead of through Clockword gem as I'm currently doing
